...
export class CreateFulfillmentOrderRequest {
   ...
   * @param items {module:fulfillmentOutbound_2020-07-01/js-client.fulfillmentOutbound_2020-07-01.model/CreateFulfillmentOrderItemList} A list of items to include in the fulfillment order preview, including quantity. Maximum of 100 line items with a maximum of 250 units per order.
   */
