...
* @alias module:services/ApiClient
* @class
*/
export class ApiClient {
    ...
    * @param {module:services/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
...
* @type {module:services/ApiClient}
*/
