...
export class ItemBrowseClassification {
   ...
   * @class
   * @param displayName {String} Display name for the classification (browse node).
 ...
 * @member {module:catalogItems_2022-04-01/js-client.catalogItems_2022-04-01.model/ItemBrowseClassification} parent
 */
