...
export class VendorShippingApi {
    ...
    */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.limit The limit to the number of records returned. Default value is 50 records.
     * @param {module:vendorShipments/js-client.vendorShipments.model/String} opts.sortOrder Sort the list by shipment label creation date in ascending or descending order.
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:vendorShipments/js-client.vendorShipments.model/GetShipmentLabels} and HTTP response
     */
     ...
     * @param {String} opts.vendorShipmentIdentifier Get Shipment labels by passing vendor shipment identifier.
     * @param {String} opts.sellerWarehouseCode Get Shipping labels based on vendor warehouse code. This value must be same as the `sellingParty.partyId` in the shipment.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:vendorShipments/js-client.vendorShipments.model/GetShipmentLabels}
     */
