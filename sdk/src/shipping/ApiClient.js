...
* @alias module:shipping/ApiClient
* @class
*/
export class ApiClient {
    ...
    * @param {module:shipping/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
...
* @type {module:shipping/ApiClient}
*/
