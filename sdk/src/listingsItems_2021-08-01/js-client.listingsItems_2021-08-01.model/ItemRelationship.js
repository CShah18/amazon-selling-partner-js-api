 ...
 * @module listingsItems_2021-08-01/js-client.listingsItems_2021-08-01.model/ItemRelationship
 * @version 2021-08-01
 */
export class ItemRelationship {
   ...
   * @alias module:listingsItems_2021-08-01/js-client.listingsItems_2021-08-01.model/ItemRelationship
   * @class
   * @param type {module:listingsItems_2021-08-01/js-client.listingsItems_2021-08-01.model/ItemRelationship.TypeEnum} The type of relationship.
   */
  constructor(type) {
    this.type = type;
  }
   ...
   * @param {module:listingsItems_2021-08-01/js-client.listingsItems_2021-08-01.model/ItemRelationship} obj Optional instance to populate.
   * @return {module:listingsItems_2021-08-01/js-client.listingsItems_2021-08-01.model/ItemRelationship} The populated <code>ItemRelationship</code> instance.
   */
 ...
 * @member {module:listingsItems_2021-08-01/js-client.listingsItems_2021-08-01.model/ItemVariationTheme} variationTheme
 */
 ...
 * @member {module:listingsItems_2021-08-01/js-client.listingsItems_2021-08-01.model/ItemRelationship.TypeEnum} type
 */
