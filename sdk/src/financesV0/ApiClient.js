...
* @alias module:financesV0/ApiClient
* @class
*/
export class ApiClient {
    ...
    * @param {module:financesV0/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
...
* @type {module:financesV0/ApiClient}
*/
