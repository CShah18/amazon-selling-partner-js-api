...
* @alias module:messaging/ApiClient
* @class
*/
export class ApiClient {
    ...
    * @param {module:messaging/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
...
* @type {module:messaging/ApiClient}
*/
