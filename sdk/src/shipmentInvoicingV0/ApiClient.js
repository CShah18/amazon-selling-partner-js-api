...
/**
* @module shipmentInvoicingV0/ApiClient
* @version v0
*/
...
* @alias module:shipmentInvoicingV0/ApiClient
* @class
*/
export class ApiClient {
    ...
    */
    constructor(baseUrl) {
         ...
         */
        this.basePath = baseUrl ? baseUrl.replace(/\/+$/, '') : 'https://localhost'.replace(/\/+$/, '');
    ...
    * @param {module:shipmentInvoicingV0/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
...
* @type {module:shipmentInvoicingV0/ApiClient}
*/
