...
* @alias module:fbaInbound/ApiClient
* @class
*/
export class ApiClient {
    ...
    * @param {module:fbaInbound/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
...
* @type {module:fbaInbound/ApiClient}
*/
