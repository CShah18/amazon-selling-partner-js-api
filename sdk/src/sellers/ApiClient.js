...
* @alias module:sellers/ApiClient
* @class
*/
export class ApiClient {
    ...
    * @param {module:sellers/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
