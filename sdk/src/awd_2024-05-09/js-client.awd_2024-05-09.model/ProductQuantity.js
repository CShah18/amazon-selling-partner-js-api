...
export class ProductQuantity {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('prepDetails'))
        obj.prepDetails = PrepDetails.constructFromObject(data['prepDetails']);
    }
    return obj;
  }
}
 ...
 * @member {module:awd_2024-05-09/js-client.awd_2024-05-09.model/PrepDetails} prepDetails
 */
