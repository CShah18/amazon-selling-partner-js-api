...
/**
* @module vendorDirectFulfillmentSandboxData_2021-10-28/ApiClient
* @version 2021-10-28
*/
...
* @alias module:vendorDirectFulfillmentSandboxData_2021-10-28/ApiClient
* @class
*/
export class ApiClient {
    ...
    */
    constructor(baseUrl) {
         ...
         * @type {String}
         * @default https://sandbox.sellingpartnerapi-na.amazon.com
         */
        this.basePath = baseUrl ? baseUrl.replace(/\/+$/, '') : 'https://sandbox.sellingpartnerapi-na.amazon.com'.replace(/\/+$/, '');
    ...
    * @param {module:vendorDirectFulfillmentSandboxData_2021-10-28/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
...
* @type {module:vendorDirectFulfillmentSandboxData_2021-10-28/ApiClient}
*/
