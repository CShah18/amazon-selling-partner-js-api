...
* @alias module:shippingV2/ApiClient
* @class
*/
export class ApiClient {
    ...
    * @param {module:shippingV2/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
...
* @type {module:shippingV2/ApiClient}
*/
