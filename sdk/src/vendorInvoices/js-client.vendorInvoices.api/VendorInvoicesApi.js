...
* @module vendorInvoices/js-client.vendorInvoices.api/VendorInvoicesApi
* @version v1
*/
export class VendorInvoicesApi {

    /**
    * Constructs a new VendorInvoicesApi. 
    * @alias module:vendorInvoices/js-client.vendorInvoices.api/VendorInvoicesApi
    * @class
