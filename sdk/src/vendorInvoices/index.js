...
import {NetCostUnitOfMeasure} from './js-client.vendorInvoices.model/NetCostUnitOfMeasure.js';
...
import {TotalWeight} from './js-client.vendorInvoices.model/TotalWeight.js';
import {TransactionId} from './js-client.vendorInvoices.model/TransactionId.js';
import {VendorInvoicesApi} from './js-client.vendorInvoices.api/VendorInvoicesApi.js';
...
* <pre>
* var VendorInvoicesV1 = require('vendorInvoices/index'); // See note below*.
* var xxxSvc = new VendorInvoicesV1.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new VendorInvoicesV1.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new VendorInvoicesV1.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new VendorInvoicesV1.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
...
export {
     ...
     * @property {module:vendorInvoices/js-client.vendorInvoices.model/NetCostUnitOfMeasure}
     */
     ...
     * @property {module:vendorInvoices/js-client.vendorInvoices.model/TotalWeight}
     */
    TotalWeight,
    ...
    * @property {module:vendorInvoices/js-client.vendorInvoices.api/VendorInvoicesApi}
    */
    VendorInvoicesApi
};
