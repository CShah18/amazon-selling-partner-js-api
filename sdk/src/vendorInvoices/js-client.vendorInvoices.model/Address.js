 ...
 * @module vendorInvoices/js-client.vendorInvoices.model/Address
 * @version v1
 */
export class Address {
   ...
   * A physical address.
   * @alias module:vendorInvoices/js-client.vendorInvoices.model/Address
   * @class
   ...
   * @param {module:vendorInvoices/js-client.vendorInvoices.model/Address} obj Optional instance to populate.
   * @return {module:vendorInvoices/js-client.vendorInvoices.model/Address} The populated <code>Address</code> instance.
   */
