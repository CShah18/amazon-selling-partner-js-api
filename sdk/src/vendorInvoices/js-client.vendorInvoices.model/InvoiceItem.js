...
export class InvoiceItem {
   ...
   * @param netCost {module:vendorInvoices/js-client.vendorInvoices.model/Money} The item cost to Amazon, which should match the cost on the order. Price information should not be zero or negative. It indicates net unit price. Net cost means VAT is not included in cost. If items are priced by weight, this cost need to be considered in conjunction with netCostUnitOfMeasure. E.g.: $5/LB
   */
 ...
 * @member {module:vendorInvoices/js-client.vendorInvoices.model/NetCostUnitOfMeasure} netCostUnitOfMeasure
 */
