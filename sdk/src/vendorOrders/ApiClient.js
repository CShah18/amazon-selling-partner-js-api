...
* @alias module:vendorOrders/ApiClient
* @class
*/
export class ApiClient {
    ...
    * @param {module:vendorOrders/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
...
* @type {module:vendorOrders/ApiClient}
*/
