...
/**
* @module vendorTransactionStatus/ApiClient
* @version v1
*/
...
* @alias module:vendorTransactionStatus/ApiClient
* @class
*/
export class ApiClient {
    ...
    * @param {module:vendorTransactionStatus/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
...
* @type {module:vendorTransactionStatus/ApiClient}
*/
