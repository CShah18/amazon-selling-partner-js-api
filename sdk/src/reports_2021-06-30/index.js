...
* <pre>
* var ReportV20210630 = require('reports_2021-06-30/index'); // See note below*.
* var xxxSvc = new ReportV20210630.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new ReportV20210630.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new ReportV20210630.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new ReportV20210630.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
