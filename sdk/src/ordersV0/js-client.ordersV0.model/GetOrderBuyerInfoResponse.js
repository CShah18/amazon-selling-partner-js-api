 ...
 * @module ordersV0/js-client.ordersV0.model/GetOrderBuyerInfoResponse
 * @version v0
 */
export class GetOrderBuyerInfoResponse {
   ...
   * @alias module:ordersV0/js-client.ordersV0.model/GetOrderBuyerInfoResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:ordersV0/js-client.ordersV0.model/GetOrderBuyerInfoResponse} obj Optional instance to populate.
   * @return {module:ordersV0/js-client.ordersV0.model/GetOrderBuyerInfoResponse} The populated <code>GetOrderBuyerInfoResponse</code> instance.
   */
 ...
 * @member {module:ordersV0/js-client.ordersV0.model/OrderBuyerInfo} payload
 */
