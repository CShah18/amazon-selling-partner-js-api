 ...
 * @module ordersV0/js-client.ordersV0.model/TaxCollection
 * @version v0
 */
export class TaxCollection {
   ...
   * @alias module:ordersV0/js-client.ordersV0.model/TaxCollection
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:ordersV0/js-client.ordersV0.model/TaxCollection} obj Optional instance to populate.
   * @return {module:ordersV0/js-client.ordersV0.model/TaxCollection} The populated <code>TaxCollection</code> instance.
   */
 ...
 * @member {module:ordersV0/js-client.ordersV0.model/TaxCollection.ModelEnum} model
 */
...
TaxCollection.ResponsiblePartyEnum = {
   ...
   * @const
   */
  amazonServicesInc_: "Amazon Services, Inc."
};

/**
 * The party responsible for withholding the taxes and remitting them to the taxing authority.
 * @member {module:ordersV0/js-client.ordersV0.model/TaxCollection.ResponsiblePartyEnum} responsibleParty
 */
