...
* @alias module:ordersV0/ApiClient
* @class
*/
export class ApiClient {
    ...
    * @param {module:ordersV0/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
...
* @type {module:ordersV0/ApiClient}
*/
