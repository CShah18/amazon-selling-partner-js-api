...
(function(root, factory) {
  ...
  describe('sellers', function() {
    describe('MarketplaceParticipationList', function() {
      beforeEach(function() {
        instance = new TheSellingPartnerApiForSellers.MarketplaceParticipationList();
      });
      ...
      it('should create an instance of MarketplaceParticipationList', function() {
        ...
        expect(instance).to.be.a(TheSellingPartnerApiForSellers.MarketplaceParticipationList);
      });
