...
(function(root, factory) {
  ...
  describe('vendorDirectFulfillmentShipping_2021-12-28', function() {
    describe('CustomerInvoiceList', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForDirectFulfillmentShipping.CustomerInvoiceList();
      });

      it('should create an instance of CustomerInvoiceList', function() {
        // TODO: update the code to test CustomerInvoiceList
      ...
      it('should have the property customerInvoices (base name: "customerInvoices")', function() {
        // TODO: update the code to test the property customerInvoices
        expect(instance).to.have.property('customerInvoices');
        // expect(instance.customerInvoices).to.be(expectedValueLiteral);
      });
