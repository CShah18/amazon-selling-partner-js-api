...
(function(root, factory) {
  ...
  describe('vendorDirectFulfillmentShipping_2021-12-28', function() {
    describe('Packages', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForDirectFulfillmentShipping.Packages();
      });

      it('should create an instance of Packages', function() {
        // TODO: update the code to test Packages
        expect(instance).to.be.a(SellingPartnerApiForDirectFulfillmentShipping.Packages);
      });
