  ...
  describe('vendorDirectFulfillmentShipping_2021-12-28', function() {
    describe('CreateContainerLabelResponse', function() {
      ...
      it('should create an instance of CreateContainerLabelResponse', function() {
        // TODO: update the code to test CreateContainerLabelResponse
      ...
      it('should have the property containerLabel (base name: "containerLabel")', function() {
        // TODO: update the code to test the property containerLabel
        expect(instance).to.have.property('containerLabel');
        // expect(instance.containerLabel).to.be(expectedValueLiteral);
      });
