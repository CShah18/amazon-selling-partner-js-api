          ...
          instance.getSellingPartnerMetrics(opts).then(function(data) {
            ...
            expect(data).to.be.a(SellingPartnerApiForReplenishment.GetSellingPartnerMetricsResponse);
            {
              ...
              for (let p in dataCtr) {
                ...
                expect(data.revenueFromSubscriptionsWithMultipleDeliveries).to.be.a('number');
                // expect(data.revenueFromSubscriptionsWithMultipleDeliveries).to.be(0.0);
                expect(data.revenueFromActiveSubscriptionsWithSingleDelivery).to.be.a('number');
                // expect(data.revenueFromActiveSubscriptionsWithSingleDelivery).to.be(0.0);
                expect(data.revenueFromCancelledSubscriptionsAfterSingleDelivery).to.be.a('number');
                // expect(data.revenueFromCancelledSubscriptionsAfterSingleDelivery).to.be(0.0);
                expect(data.subscriberRetentionFor30Days).to.be.a('number');
                // expect(data.subscriberRetentionFor30Days).to.be(0.0);
                expect(data.subscriberRetentionFor90Days).to.be.a('number');
                // expect(data.subscriberRetentionFor90Days).to.be(0.0);
                expect(data.revenuePenetrationFor0PercentSellerFunding).to.be.a('number');
                // expect(data.revenuePenetrationFor0PercentSellerFunding).to.be(0.0);
                expect(data.revenuePenetrationFor5PercentSellerFunding).to.be.a('number');
                // expect(data.revenuePenetrationFor5PercentSellerFunding).to.be(0.0);
                expect(data.revenuePenetrationFor10PercentSellerFunding).to.be.a('number');
                // expect(data.revenuePenetrationFor10PercentSellerFunding).to.be(0.0);
                expect(data.revenuePenetrationFor5PlusPercentSellerFunding).to.be.a('number');
                // expect(data.revenuePenetrationFor5PlusPercentSellerFunding).to.be(0.0);
                expect(data.shareOfCouponSubscriptions).to.be.a('number');
                // expect(data.shareOfCouponSubscriptions).to.be(0.0);
