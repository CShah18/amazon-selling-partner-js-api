...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('HazmatType', function() {
      beforeEach(function() {
        instance = SellingPartnerApiForMerchantFulfillment.HazmatType;
      });

      it('should create an instance of HazmatType', function() {
        // TODO: update the code to test HazmatType
      ...
      it('should have the property lQHazmat', function() {
        expect(instance).to.have.property('lQHazmat');
        expect(instance.lQHazmat).to.be("LQHazmat");
      });
