...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('CountryCode', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMerchantFulfillment.CountryCode();
      });

      it('should create an instance of CountryCode', function() {
        // TODO: update the code to test CountryCode
        expect(instance).to.be.a(SellingPartnerApiForMerchantFulfillment.CountryCode);
      });
