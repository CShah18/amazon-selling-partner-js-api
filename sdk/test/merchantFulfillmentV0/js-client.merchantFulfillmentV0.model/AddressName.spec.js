...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('AddressName', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMerchantFulfillment.AddressName();
      });

      it('should create an instance of AddressName', function() {
        // TODO: update the code to test AddressName
        expect(instance).to.be.a(SellingPartnerApiForMerchantFulfillment.AddressName);
      });
