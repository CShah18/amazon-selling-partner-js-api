...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('AvailableDeliveryExperienceOption', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMerchantFulfillment.AvailableDeliveryExperienceOption();
      });

      it('should create an instance of AvailableDeliveryExperienceOption', function() {
        // TODO: update the code to test AvailableDeliveryExperienceOption
      ...
      it('should have the property deliveryExperienceOption (base name: "DeliveryExperienceOption")', function() {
        // TODO: update the code to test the property deliveryExperienceOption
        expect(instance).to.have.property('deliveryExperienceOption');
        // expect(instance.deliveryExperienceOption).to.be(expectedValueLiteral);
      });
