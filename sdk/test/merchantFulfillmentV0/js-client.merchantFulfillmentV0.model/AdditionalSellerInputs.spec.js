  ...
  describe('merchantFulfillmentV0', function() {
    describe('AdditionalSellerInputs', function() {
      ...
      it('should create an instance of AdditionalSellerInputs', function() {
        // TODO: update the code to test AdditionalSellerInputs
      ...
      it('should have the property additionalInputFieldName (base name: "AdditionalInputFieldName")', function() {
        // TODO: update the code to test the property additionalInputFieldName
        expect(instance).to.have.property('additionalInputFieldName');
        // expect(instance.additionalInputFieldName).to.be(expectedValueLiteral);
      });

      it('should have the property additionalSellerInput (base name: "AdditionalSellerInput")', function() {
        // TODO: update the code to test the property additionalSellerInput
        expect(instance).to.have.property('additionalSellerInput');
        // expect(instance.additionalSellerInput).to.be(expectedValueLiteral);
      });
