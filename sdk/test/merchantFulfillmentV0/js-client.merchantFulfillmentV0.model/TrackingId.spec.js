...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('TrackingId', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMerchantFulfillment.TrackingId();
      });

      it('should create an instance of TrackingId', function() {
        // TODO: update the code to test TrackingId
        expect(instance).to.be.a(SellingPartnerApiForMerchantFulfillment.TrackingId);
      });
