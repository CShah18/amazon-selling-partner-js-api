...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('ItemDescription', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMerchantFulfillment.ItemDescription();
      });

      it('should create an instance of ItemDescription', function() {
        // TODO: update the code to test ItemDescription
        expect(instance).to.be.a(SellingPartnerApiForMerchantFulfillment.ItemDescription);
      });
