  ...
  describe('merchantFulfillmentV0', function() {
    describe('GetEligibleShipmentServicesRequest', function() {
      ...
      it('should create an instance of GetEligibleShipmentServicesRequest', function() {
        // TODO: update the code to test GetEligibleShipmentServicesRequest
      ...
      it('should have the property shippingOfferingFilter (base name: "ShippingOfferingFilter")', function() {
        // TODO: update the code to test the property shippingOfferingFilter
        expect(instance).to.have.property('shippingOfferingFilter');
        // expect(instance.shippingOfferingFilter).to.be(expectedValueLiteral);
      });
