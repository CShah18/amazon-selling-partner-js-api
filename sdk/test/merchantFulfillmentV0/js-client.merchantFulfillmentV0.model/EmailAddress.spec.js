...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('EmailAddress', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMerchantFulfillment.EmailAddress();
      });

      it('should create an instance of EmailAddress', function() {
        // TODO: update the code to test EmailAddress
        expect(instance).to.be.a(SellingPartnerApiForMerchantFulfillment.EmailAddress);
      });
