  ...
  describe('merchantFulfillmentV0', function() {
    describe('AdditionalInputs', function() {
      ...
      it('should create an instance of AdditionalInputs', function() {
        // TODO: update the code to test AdditionalInputs
      ...
      it('should have the property sellerInputDefinition (base name: "SellerInputDefinition")', function() {
        // TODO: update the code to test the property sellerInputDefinition
        expect(instance).to.have.property('sellerInputDefinition');
        // expect(instance.sellerInputDefinition).to.be(expectedValueLiteral);
      });
