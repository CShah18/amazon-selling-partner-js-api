...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('ExcludedBenefit', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMerchantFulfillment.ExcludedBenefit();
      });

      it('should create an instance of ExcludedBenefit', function() {
        // TODO: update the code to test ExcludedBenefit
      ...
      it('should have the property benefit (base name: "Benefit")', function() {
        // TODO: update the code to test the property benefit
        expect(instance).to.have.property('benefit');
        // expect(instance.benefit).to.be(expectedValueLiteral);
      });

      it('should have the property reasonCodes (base name: "ReasonCodes")', function() {
        // TODO: update the code to test the property reasonCodes
        expect(instance).to.have.property('reasonCodes');
        // expect(instance.reasonCodes).to.be(expectedValueLiteral);
      });
