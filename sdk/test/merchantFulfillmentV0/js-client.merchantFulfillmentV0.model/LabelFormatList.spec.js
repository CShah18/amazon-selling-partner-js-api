...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('LabelFormatList', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMerchantFulfillment.LabelFormatList();
      });

      it('should create an instance of LabelFormatList', function() {
        // TODO: update the code to test LabelFormatList
        expect(instance).to.be.a(SellingPartnerApiForMerchantFulfillment.LabelFormatList);
      });
