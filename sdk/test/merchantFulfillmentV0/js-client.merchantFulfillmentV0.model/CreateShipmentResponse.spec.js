...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('CreateShipmentResponse', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMerchantFulfillment.CreateShipmentResponse();
      });

      it('should create an instance of CreateShipmentResponse', function() {
        // TODO: update the code to test CreateShipmentResponse
