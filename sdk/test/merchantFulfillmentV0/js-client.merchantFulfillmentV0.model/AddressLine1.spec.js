...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('AddressLine1', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMerchantFulfillment.AddressLine1();
      });

      it('should create an instance of AddressLine1', function() {
        // TODO: update the code to test AddressLine1
        expect(instance).to.be.a(SellingPartnerApiForMerchantFulfillment.AddressLine1);
      });
