...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('ShipmentId', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMerchantFulfillment.ShipmentId();
      });

      it('should create an instance of ShipmentId', function() {
        // TODO: update the code to test ShipmentId
        expect(instance).to.be.a(SellingPartnerApiForMerchantFulfillment.ShipmentId);
      });
