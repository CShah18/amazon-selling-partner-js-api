...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('LabelDimension', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMerchantFulfillment.LabelDimension();
      });

      it('should create an instance of LabelDimension', function() {
        // TODO: update the code to test LabelDimension
        expect(instance).to.be.a(SellingPartnerApiForMerchantFulfillment.LabelDimension);
      });
