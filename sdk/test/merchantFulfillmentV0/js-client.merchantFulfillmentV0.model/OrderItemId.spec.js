...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('OrderItemId', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMerchantFulfillment.OrderItemId();
      });

      it('should create an instance of OrderItemId', function() {
        // TODO: update the code to test OrderItemId
        expect(instance).to.be.a(SellingPartnerApiForMerchantFulfillment.OrderItemId);
      });
