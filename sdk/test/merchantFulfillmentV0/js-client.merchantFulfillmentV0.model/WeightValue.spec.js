...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('WeightValue', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMerchantFulfillment.WeightValue();
      });

      it('should create an instance of WeightValue', function() {
        // TODO: update the code to test WeightValue
        expect(instance).to.be.a(SellingPartnerApiForMerchantFulfillment.WeightValue);
      });
