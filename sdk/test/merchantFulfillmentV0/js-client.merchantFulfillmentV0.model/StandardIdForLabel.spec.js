...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('StandardIdForLabel', function() {
      beforeEach(function() {
        instance = SellingPartnerApiForMerchantFulfillment.StandardIdForLabel;
      });

      it('should create an instance of StandardIdForLabel', function() {
        // TODO: update the code to test StandardIdForLabel
        expect(instance).to.be.a('object');
      });

      it('should have the property amazonOrderId', function() {
        expect(instance).to.have.property('amazonOrderId');
        expect(instance.amazonOrderId).to.be("AmazonOrderId");
      });
