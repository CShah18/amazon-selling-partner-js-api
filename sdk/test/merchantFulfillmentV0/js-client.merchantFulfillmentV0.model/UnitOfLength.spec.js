...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('UnitOfLength', function() {
      beforeEach(function() {
        instance = SellingPartnerApiForMerchantFulfillment.UnitOfLength;
      });

      it('should create an instance of UnitOfLength', function() {
        // TODO: update the code to test UnitOfLength
      ...
      it('should have the property centimeters', function() {
        expect(instance).to.have.property('centimeters');
        expect(instance.centimeters).to.be("centimeters");
      });
