...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('AddressLine3', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMerchantFulfillment.AddressLine3();
      });

      it('should create an instance of AddressLine3', function() {
        // TODO: update the code to test AddressLine3
        expect(instance).to.be.a(SellingPartnerApiForMerchantFulfillment.AddressLine3);
      });
