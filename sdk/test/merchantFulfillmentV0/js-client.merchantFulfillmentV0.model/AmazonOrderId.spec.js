...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('AmazonOrderId', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMerchantFulfillment.AmazonOrderId();
      });

      it('should create an instance of AmazonOrderId', function() {
        // TODO: update the code to test AmazonOrderId
        expect(instance).to.be.a(SellingPartnerApiForMerchantFulfillment.AmazonOrderId);
      });
