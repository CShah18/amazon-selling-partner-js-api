...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('Constraints', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMerchantFulfillment.Constraints();
      });

      it('should create an instance of Constraints', function() {
        // TODO: update the code to test Constraints
        expect(instance).to.be.a(SellingPartnerApiForMerchantFulfillment.Constraints);
      });
