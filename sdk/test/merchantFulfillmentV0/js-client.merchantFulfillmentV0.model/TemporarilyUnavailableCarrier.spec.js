...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('TemporarilyUnavailableCarrier', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMerchantFulfillment.TemporarilyUnavailableCarrier();
      });

      it('should create an instance of TemporarilyUnavailableCarrier', function() {
        // TODO: update the code to test TemporarilyUnavailableCarrier
