...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('TermsAndConditionsNotAcceptedCarrier', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMerchantFulfillment.TermsAndConditionsNotAcceptedCarrier();
      });

      it('should create an instance of TermsAndConditionsNotAcceptedCarrier', function() {
        // TODO: update the code to test TermsAndConditionsNotAcceptedCarrier
        expect(instance).to.be.a(SellingPartnerApiForMerchantFulfillment.TermsAndConditionsNotAcceptedCarrier);
      });
