...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('AddressLine2', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMerchantFulfillment.AddressLine2();
      });

      it('should create an instance of AddressLine2', function() {
        // TODO: update the code to test AddressLine2
        expect(instance).to.be.a(SellingPartnerApiForMerchantFulfillment.AddressLine2);
      });
