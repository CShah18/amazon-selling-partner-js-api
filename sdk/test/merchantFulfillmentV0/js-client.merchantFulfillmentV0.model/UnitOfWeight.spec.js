...
(function(root, factory) {
  ...
  describe('merchantFulfillmentV0', function() {
    describe('UnitOfWeight', function() {
      beforeEach(function() {
        instance = SellingPartnerApiForMerchantFulfillment.UnitOfWeight;
      });
      ...
      it('should have the property oz', function() {
        expect(instance).to.have.property('oz');
        expect(instance.oz).to.be("oz");
      });

      it('should have the property g', function() {
        expect(instance).to.have.property('g');
        expect(instance.g).to.be("g");
      });
