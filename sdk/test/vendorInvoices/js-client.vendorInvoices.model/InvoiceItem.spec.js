...
(function(root, factory) {
  ...
  describe('vendorInvoices', function() {
    describe('InvoiceItem', function() {
      beforeEach(function() {
        instance = new VendorInvoicesV1.InvoiceItem();
      });

      it('should create an instance of InvoiceItem', function() {
        // TODO: update the code to test InvoiceItem
        expect(instance).to.be.a(VendorInvoicesV1.InvoiceItem);
      });
      ...
      it('should have the property netCostUnitOfMeasure (base name: "netCostUnitOfMeasure")', function() {
        // TODO: update the code to test the property netCostUnitOfMeasure
        expect(instance).to.have.property('netCostUnitOfMeasure');
        // expect(instance.netCostUnitOfMeasure).to.be(expectedValueLiteral);
      });
