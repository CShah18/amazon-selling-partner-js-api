    ...
    describe('VendorShippingApi', function() {
                      ...
                      // expect(data.shipWindow).to.be("");
                      {
                        ...
                        for (let p in dataCtr) {
                          ...
                          expect(data.shippedQuantity).to.be.a(SellingPartnerApiForRetailProcurementShipments.ItemQuantity);
                            ...
                            expect(data.shippedQuantity.totalWeight).to.be.a(SellingPartnerApiForRetailProcurementShipments.TotalWeight);
                                  expect(data.shippedQuantity.totalWeight.unitOfMeasure).to.be.a('string');
                              // expect(data.shippedQuantity.totalWeight.unitOfMeasure).to.be("POUNDS");
                              expect(data.shippedQuantity.totalWeight.amount).to.be.a(SellingPartnerApiForRetailProcurementShipments.Decimal);
                        ...
                        }
                      {
                        ...
                        for (let p in dataCtr) {
                          ...
                          expect(data.packedQuantity).to.be.a(SellingPartnerApiForRetailProcurementShipments.ItemQuantity);
                            ...
                            expect(data.packedQuantity.totalWeight).to.be.a(SellingPartnerApiForRetailProcurementShipments.TotalWeight);
                                  expect(data.packedQuantity.totalWeight.unitOfMeasure).to.be.a('string');
                              // expect(data.packedQuantity.totalWeight.unitOfMeasure).to.be("POUNDS");
                              expect(data.packedQuantity.totalWeight.amount).to.be.a(SellingPartnerApiForRetailProcurementShipments.Decimal);
      ...
      describe('getShipmentLabels', function() {
        it('should call getShipmentLabels successfully', function(done) {
          // TODO: uncomment, update parameter values for getShipmentLabels call and complete the assertions
          /*
          var opts = {};
          opts.limit = 789;
          opts.sortOrder = "sortOrder_example";
          opts.nextToken = "nextToken_example";
          opts.labelCreatedAfter = new Date("2013-10-20T19:20:30+01:00");
          opts.labelCreatedBefore = new Date("2013-10-20T19:20:30+01:00");
          opts.buyerReferenceNumber = "buyerReferenceNumber_example";
          opts.vendorShipmentIdentifier = "vendorShipmentIdentifier_example";
          opts.sellerWarehouseCode = "sellerWarehouseCode_example";

          instance.getShipmentLabels(opts).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SellingPartnerApiForRetailProcurementShipments.GetShipmentLabels);
            expect(data.payload).to.be.a(SellingPartnerApiForRetailProcurementShipments.TransportationLabels);
                  expect(data.payload.pagination).to.be.a(SellingPartnerApiForRetailProcurementShipments.Pagination);
                    expect(data.payload.pagination.nextToken).to.be.a('string');
                // expect(data.payload.pagination.nextToken).to.be("");
              {
                let dataCtr = data.payload.transportLabels;
                expect(dataCtr).to.be.an(Array);
                expect(dataCtr).to.not.be.empty();
                for (let p in dataCtr) {
                  let data = dataCtr[p];
                  expect(data).to.be.a(SellingPartnerApiForRetailProcurementShipments.TransportLabel);
                  expect(data.labelCreateDateTime).to.be.a(Date);
                  // expect(data.labelCreateDateTime).to.be(new Date());
                  expect(data.shipmentInformation).to.be.a(SellingPartnerApiForRetailProcurementShipments.ShipmentInformation);
                        expect(data.shipmentInformation.vendorDetails).to.be.a(SellingPartnerApiForRetailProcurementShipments.VendorDetails);
                          expect(data.shipmentInformation.vendorDetails.sellingParty).to.be.a(SellingPartnerApiForRetailProcurementShipments.PartyIdentification);
                            expect(data.shipmentInformation.vendorDetails.sellingParty.address).to.be.a(SellingPartnerApiForRetailProcurementShipments.Address);
                              expect(data.shipmentInformation.vendorDetails.sellingParty.address.name).to.be.a('string');
                          // expect(data.shipmentInformation.vendorDetails.sellingParty.address.name).to.be("");
                          expect(data.shipmentInformation.vendorDetails.sellingParty.address.addressLine1).to.be.a('string');
                          // expect(data.shipmentInformation.vendorDetails.sellingParty.address.addressLine1).to.be("");
                          expect(data.shipmentInformation.vendorDetails.sellingParty.address.addressLine2).to.be.a('string');
                          // expect(data.shipmentInformation.vendorDetails.sellingParty.address.addressLine2).to.be("");
                          expect(data.shipmentInformation.vendorDetails.sellingParty.address.addressLine3).to.be.a('string');
                          // expect(data.shipmentInformation.vendorDetails.sellingParty.address.addressLine3).to.be("");
                          expect(data.shipmentInformation.vendorDetails.sellingParty.address.city).to.be.a('string');
                          // expect(data.shipmentInformation.vendorDetails.sellingParty.address.city).to.be("");
                          expect(data.shipmentInformation.vendorDetails.sellingParty.address.county).to.be.a('string');
                          // expect(data.shipmentInformation.vendorDetails.sellingParty.address.county).to.be("");
                          expect(data.shipmentInformation.vendorDetails.sellingParty.address.district).to.be.a('string');
                          // expect(data.shipmentInformation.vendorDetails.sellingParty.address.district).to.be("");
                          expect(data.shipmentInformation.vendorDetails.sellingParty.address.stateOrRegion).to.be.a('string');
                          // expect(data.shipmentInformation.vendorDetails.sellingParty.address.stateOrRegion).to.be("");
                          expect(data.shipmentInformation.vendorDetails.sellingParty.address.postalCode).to.be.a('string');
                          // expect(data.shipmentInformation.vendorDetails.sellingParty.address.postalCode).to.be("");
                          expect(data.shipmentInformation.vendorDetails.sellingParty.address.countryCode).to.be.a('string');
                          // expect(data.shipmentInformation.vendorDetails.sellingParty.address.countryCode).to.be("");
                          expect(data.shipmentInformation.vendorDetails.sellingParty.address.phone).to.be.a('string');
                          // expect(data.shipmentInformation.vendorDetails.sellingParty.address.phone).to.be("");
                        expect(data.shipmentInformation.vendorDetails.sellingParty.partyId).to.be.a('string');
                        // expect(data.shipmentInformation.vendorDetails.sellingParty.partyId).to.be("");
                        {
                          let dataCtr = data.shipmentInformation.vendorDetails.sellingParty.taxRegistrationDetails;
                          expect(dataCtr).to.be.an(Array);
                          expect(dataCtr).to.not.be.empty();
                          for (let p in dataCtr) {
                            let data = dataCtr[p];
                      ...
                      expect(data.shipmentInformation.vendorDetails.vendorShipmentIdentifier).to.be.a('string');
                      // expect(data.shipmentInformation.vendorDetails.vendorShipmentIdentifier).to.be("");
                    expect(data.shipmentInformation.buyerReferenceNumber).to.be.a('string');
                    // expect(data.shipmentInformation.buyerReferenceNumber).to.be("");
                    expect(data.shipmentInformation.shipToParty).to.be.a(SellingPartnerApiForRetailProcurementShipments.PartyIdentification);
                          expect(data.shipmentInformation.shipToParty.address).to.be.a(SellingPartnerApiForRetailProcurementShipments.Address);
                            expect(data.shipmentInformation.shipToParty.address.name).to.be.a('string');
                        // expect(data.shipmentInformation.shipToParty.address.name).to.be("");
                        expect(data.shipmentInformation.shipToParty.address.addressLine1).to.be.a('string');
                        // expect(data.shipmentInformation.shipToParty.address.addressLine1).to.be("");
                        expect(data.shipmentInformation.shipToParty.address.addressLine2).to.be.a('string');
                        // expect(data.shipmentInformation.shipToParty.address.addressLine2).to.be("");
                        expect(data.shipmentInformation.shipToParty.address.addressLine3).to.be.a('string');
                        // expect(data.shipmentInformation.shipToParty.address.addressLine3).to.be("");
                        expect(data.shipmentInformation.shipToParty.address.city).to.be.a('string');
                        // expect(data.shipmentInformation.shipToParty.address.city).to.be("");
                        expect(data.shipmentInformation.shipToParty.address.county).to.be.a('string');
                        // expect(data.shipmentInformation.shipToParty.address.county).to.be("");
                        expect(data.shipmentInformation.shipToParty.address.district).to.be.a('string');
                        // expect(data.shipmentInformation.shipToParty.address.district).to.be("");
                        expect(data.shipmentInformation.shipToParty.address.stateOrRegion).to.be.a('string');
                        // expect(data.shipmentInformation.shipToParty.address.stateOrRegion).to.be("");
                        expect(data.shipmentInformation.shipToParty.address.postalCode).to.be.a('string');
                        // expect(data.shipmentInformation.shipToParty.address.postalCode).to.be("");
                        expect(data.shipmentInformation.shipToParty.address.countryCode).to.be.a('string');
                        // expect(data.shipmentInformation.shipToParty.address.countryCode).to.be("");
                        expect(data.shipmentInformation.shipToParty.address.phone).to.be.a('string');
                        // expect(data.shipmentInformation.shipToParty.address.phone).to.be("");
                      expect(data.shipmentInformation.shipToParty.partyId).to.be.a('string');
                      // expect(data.shipmentInformation.shipToParty.partyId).to.be("");
                      {
                        let dataCtr = data.shipmentInformation.shipToParty.taxRegistrationDetails;
                        expect(dataCtr).to.be.an(Array);
                        expect(dataCtr).to.not.be.empty();
                        for (let p in dataCtr) {
                          let data = dataCtr[p];
                    ...
                    expect(data.shipmentInformation.shipFromParty).to.be.a(SellingPartnerApiForRetailProcurementShipments.PartyIdentification);
                          expect(data.shipmentInformation.shipFromParty.address).to.be.a(SellingPartnerApiForRetailProcurementShipments.Address);
                            expect(data.shipmentInformation.shipFromParty.address.name).to.be.a('string');
                        // expect(data.shipmentInformation.shipFromParty.address.name).to.be("");
                        expect(data.shipmentInformation.shipFromParty.address.addressLine1).to.be.a('string');
                        // expect(data.shipmentInformation.shipFromParty.address.addressLine1).to.be("");
                        expect(data.shipmentInformation.shipFromParty.address.addressLine2).to.be.a('string');
                        // expect(data.shipmentInformation.shipFromParty.address.addressLine2).to.be("");
                        expect(data.shipmentInformation.shipFromParty.address.addressLine3).to.be.a('string');
                        // expect(data.shipmentInformation.shipFromParty.address.addressLine3).to.be("");
                        expect(data.shipmentInformation.shipFromParty.address.city).to.be.a('string');
                        // expect(data.shipmentInformation.shipFromParty.address.city).to.be("");
                        expect(data.shipmentInformation.shipFromParty.address.county).to.be.a('string');
                        // expect(data.shipmentInformation.shipFromParty.address.county).to.be("");
                        expect(data.shipmentInformation.shipFromParty.address.district).to.be.a('string');
                        // expect(data.shipmentInformation.shipFromParty.address.district).to.be("");
                        expect(data.shipmentInformation.shipFromParty.address.stateOrRegion).to.be.a('string');
                        // expect(data.shipmentInformation.shipFromParty.address.stateOrRegion).to.be("");
                        expect(data.shipmentInformation.shipFromParty.address.postalCode).to.be.a('string');
                        // expect(data.shipmentInformation.shipFromParty.address.postalCode).to.be("");
                        expect(data.shipmentInformation.shipFromParty.address.countryCode).to.be.a('string');
                        // expect(data.shipmentInformation.shipFromParty.address.countryCode).to.be("");
                        expect(data.shipmentInformation.shipFromParty.address.phone).to.be.a('string');
                        // expect(data.shipmentInformation.shipFromParty.address.phone).to.be("");
                      expect(data.shipmentInformation.shipFromParty.partyId).to.be.a('string');
                      // expect(data.shipmentInformation.shipFromParty.partyId).to.be("");
                      {
                        let dataCtr = data.shipmentInformation.shipFromParty.taxRegistrationDetails;
                        expect(dataCtr).to.be.an(Array);
                        expect(dataCtr).to.not.be.empty();
                        for (let p in dataCtr) {
                          let data = dataCtr[p];
                    ...
                    expect(data.shipmentInformation.warehouseId).to.be.a('string');
                    // expect(data.shipmentInformation.warehouseId).to.be("");
                    expect(data.shipmentInformation.masterTrackingId).to.be.a('string');
                    // expect(data.shipmentInformation.masterTrackingId).to.be("");
                    expect(data.shipmentInformation.totalLabelCount).to.be.a('number');
                    // expect(data.shipmentInformation.totalLabelCount).to.be(0);
                    expect(data.shipmentInformation.shipMode).to.be.a('string');
                    // expect(data.shipmentInformation.shipMode).to.be("SmallParcel");
                  {
                    ...
                    for (let p in dataCtr) {
                      let data = dataCtr[p];
                      expect(data).to.be.a(SellingPartnerApiForRetailProcurementShipments.LabelData);
                      expect(data.labelSequenceNumber).to.be.a('number');
                      // expect(data.labelSequenceNumber).to.be(0);
                      expect(data.labelFormat).to.be.a('string');
                      // expect(data.labelFormat).to.be("PDF");
                      expect(data.carrierCode).to.be.a('string');
                      // expect(data.carrierCode).to.be("");
      ...
      describe('submitShipmentConfirmations', function() {
        it('should call submitShipmentConfirmations successfully', function(done) {
          ...
          body.shipmentConfirmations[0].shippedItems[0].shippedQuantity.totalWeight = new SellingPartnerApiForRetailProcurementShipments.TotalWeight();
          body.shipmentConfirmations[0].shippedItems[0].shippedQuantity.totalWeight.unitOfMeasure = "POUNDS";
          body.shipmentConfirmations[0].shippedItems[0].shippedQuantity.totalWeight.amount = new SellingPartnerApiForRetailProcurementShipments.Decimal();
          ...
          body.shipmentConfirmations[0].cartons[0].items[0].shippedQuantity.totalWeight = new SellingPartnerApiForRetailProcurementShipments.TotalWeight();
          body.shipmentConfirmations[0].cartons[0].items[0].shippedQuantity.totalWeight.unitOfMeasure = "POUNDS";
          body.shipmentConfirmations[0].cartons[0].items[0].shippedQuantity.totalWeight.amount = new SellingPartnerApiForRetailProcurementShipments.Decimal();
          ...
          body.shipmentConfirmations[0].pallets[0].items[0].shippedQuantity.totalWeight = new SellingPartnerApiForRetailProcurementShipments.TotalWeight();
          body.shipmentConfirmations[0].pallets[0].items[0].shippedQuantity.totalWeight.unitOfMeasure = "POUNDS";
          body.shipmentConfirmations[0].pallets[0].items[0].shippedQuantity.totalWeight.amount = new SellingPartnerApiForRetailProcurementShipments.Decimal();
      ...
      describe('submitShipments', function() {
        it('should call submitShipments successfully', function(done) {
          ...
          body.shipments[0].purchaseOrders[0].items[0].shippedQuantity.totalWeight = new SellingPartnerApiForRetailProcurementShipments.TotalWeight();
          body.shipments[0].purchaseOrders[0].items[0].shippedQuantity.totalWeight.unitOfMeasure = "POUNDS";
          body.shipments[0].purchaseOrders[0].items[0].shippedQuantity.totalWeight.amount = new SellingPartnerApiForRetailProcurementShipments.Decimal();
          ...
          body.shipments[0].containers[0].packedItems[0].packedQuantity.totalWeight = new SellingPartnerApiForRetailProcurementShipments.TotalWeight();
          body.shipments[0].containers[0].packedItems[0].packedQuantity.totalWeight.unitOfMeasure = "POUNDS";
          body.shipments[0].containers[0].packedItems[0].packedQuantity.totalWeight.amount = new SellingPartnerApiForRetailProcurementShipments.Decimal();
