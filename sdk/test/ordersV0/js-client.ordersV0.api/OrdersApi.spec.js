...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrdersV0.OrdersApi();
  });
    ...
    describe('OrdersApi', function() {
      describe('confirmShipment', function() {
        it('should call confirmShipment successfully', function(done) {
          ...
          var payload = new OrdersV0.ConfirmShipmentRequest();
          payload.packageDetail = new OrdersV0.PackageDetail();
          payload.packageDetail.packageReferenceId = new OrdersV0.PackageReferenceId();
          ...
          payload.packageDetail.orderItems = new OrdersV0.ConfirmShipmentOrderItemsList();
          payload.codCollectionMethod = "DirectPayment";
          payload.marketplaceId = new OrdersV0.MarketplaceId();
      ...
      describe('getOrder', function() {
        it('should call getOrder successfully', function(done) {
          ...
          instance.getOrder(orderId).then(function(data) {
            ...
            expect(data).to.be.a(OrdersV0.GetOrderResponse);
            expect(data.payload).to.be.a(OrdersV0.Order);
              ...
              expect(data.payload.orderTotal).to.be.a(OrdersV0.Money);
              ...
              expect(data.payload.paymentExecutionDetail).to.be.a(OrdersV0.PaymentExecutionDetailItemList);
                  expect(data.payload.paymentMethod).to.be.a('string');
              // expect(data.payload.paymentMethod).to.be("COD");
              expect(data.payload.paymentMethodDetails).to.be.a(OrdersV0.PaymentMethodDetailItemList);
              ...
              expect(data.payload.easyShipShipmentStatus).to.be.a(OrdersV0.EasyShipShipmentStatus);
              ...
              expect(data.payload.defaultShipFromLocationAddress).to.be.a(OrdersV0.Address);
                ...
                expect(data.payload.defaultShipFromLocationAddress.extendedFields).to.be.a(OrdersV0.AddressExtendedFields);
              ...
              expect(data.payload.buyerTaxInformation).to.be.a(OrdersV0.BuyerTaxInformation);
              ...
              expect(data.payload.fulfillmentInstruction).to.be.a(OrdersV0.FulfillmentInstruction);
              ...
              expect(data.payload.marketplaceTaxInfo).to.be.a(OrdersV0.MarketplaceTaxInfo);
                    {
                  ...
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                    expect(data).to.be.a(OrdersV0.TaxClassification);
              ...
              expect(data.payload.shippingAddress).to.be.a(OrdersV0.Address);
                ...
                expect(data.payload.shippingAddress.extendedFields).to.be.a(OrdersV0.AddressExtendedFields);
              ...
              expect(data.payload.buyerInfo).to.be.a(OrdersV0.BuyerInfo);
                ...
                expect(data.payload.buyerInfo.buyerTaxInfo).to.be.a(OrdersV0.BuyerTaxInfo);
              ...
              expect(data.payload.automatedShippingSettings).to.be.a(OrdersV0.AutomatedShippingSettings);
              ...
              expect(data.payload.electronicInvoiceStatus).to.be.a(OrdersV0.ElectronicInvoiceStatus);
      
            expect(data.errors).to.be.a(OrdersV0.ErrorList);
      ...
      describe('getOrderAddress', function() {
        it('should call getOrderAddress successfully', function(done) {
          ...
          instance.getOrderAddress(orderId).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(OrdersV0.GetOrderAddressResponse);
            expect(data.payload).to.be.a(OrdersV0.OrderAddress);
                  expect(data.payload.amazonOrderId).to.be.a('string');
              // expect(data.payload.amazonOrderId).to.be("");
              ...
              expect(data.payload.shippingAddress).to.be.a(OrdersV0.Address);
                ...
                expect(data.payload.shippingAddress.addressType).to.be.a('string');
                // expect(data.payload.shippingAddress.addressType).to.be("Residential");
              expect(data.payload.deliveryPreferences).to.be.a(OrdersV0.DeliveryPreferences);
                ...
                expect(data.payload.deliveryPreferences.preferredDeliveryTime).to.be.a(OrdersV0.PreferredDeliveryTime);
                      {
                    ...
                    for (let p in dataCtr) {
                      let data = dataCtr[p];
                      expect(data).to.be.a(OrdersV0.BusinessHours);
                      ...
                      // expect(data.dayOfWeek).to.be("SUN");
                      {
                        ...
                        for (let p in dataCtr) {
                          let data = dataCtr[p];
                          expect(data).to.be.a(OrdersV0.OpenInterval);
                          expect(data.startTime).to.be.a(OrdersV0.OpenTimeInterval);
                          ...
                          expect(data.endTime).to.be.a(OrdersV0.OpenTimeInterval);
                  ...
                  }
                  {
                    ...
                    for (let p in dataCtr) {
                      let data = dataCtr[p];
                      expect(data).to.be.a(OrdersV0.ExceptionDates);
                  ...
                  }
                {
                  ...
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                    expect(data).to.be.a(OrdersV0.OtherDeliveryAttributes);
                  }
                }
      ...
      describe('getOrderBuyerInfo', function() {
        it('should call getOrderBuyerInfo successfully', function(done) {
          ...
          instance.getOrderBuyerInfo(orderId).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(OrdersV0.GetOrderBuyerInfoResponse);
            expect(data.payload).to.be.a(OrdersV0.OrderBuyerInfo);
                  expect(data.payload.amazonOrderId).to.be.a('string');
              // expect(data.payload.amazonOrderId).to.be("");
              ...
              expect(data.payload.buyerTaxInfo).to.be.a(OrdersV0.BuyerTaxInfo);
      ...
      describe('getOrderItems', function() {
        it('should call getOrderItems successfully', function(done) {
          ...
          instance.getOrderItems(orderId, opts).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(OrdersV0.GetOrderItemsResponse);
            expect(data.payload).to.be.a(OrdersV0.OrderItemsList);
                  expect(data.payload.orderItems).to.be.a(OrdersV0.OrderItemList);
      ...
      describe('getOrderItemsBuyerInfo', function() {
        it('should call getOrderItemsBuyerInfo successfully', function(done) {
          ...
          instance.getOrderItemsBuyerInfo(orderId, opts).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(OrdersV0.GetOrderItemsBuyerInfoResponse);
            expect(data.payload).to.be.a(OrdersV0.OrderItemsBuyerInfoList);
                  expect(data.payload.orderItems).to.be.a(OrdersV0.OrderItemBuyerInfoList);
                  expect(data.payload.nextToken).to.be.a('string');
              // expect(data.payload.nextToken).to.be("");
              expect(data.payload.amazonOrderId).to.be.a('string');
              // expect(data.payload.amazonOrderId).to.be("");
      ...
      describe('getOrderRegulatedInfo', function() {
        it('should call getOrderRegulatedInfo successfully', function(done) {
          ...
          instance.getOrderRegulatedInfo(orderId).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(OrdersV0.GetOrderRegulatedInfoResponse);
            expect(data.payload).to.be.a(OrdersV0.OrderRegulatedInfo);
                  expect(data.payload.amazonOrderId).to.be.a('string');
              // expect(data.payload.amazonOrderId).to.be("");
              expect(data.payload.regulatedInformation).to.be.a(OrdersV0.RegulatedInformation);
                    {
                  ...
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                    expect(data).to.be.a(OrdersV0.RegulatedInformationField);
              ...
              expect(data.payload.regulatedOrderVerificationStatus).to.be.a(OrdersV0.RegulatedOrderVerificationStatus);
                    expect(data.payload.regulatedOrderVerificationStatus.status).to.be.a(OrdersV0.VerificationStatus);
                ...
                // expect(data.payload.regulatedOrderVerificationStatus.requiresMerchantAction).to.be(false);
                {
                  ...
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                    expect(data).to.be.a(OrdersV0.RejectionReason);
                ...
                expect(data.payload.regulatedOrderVerificationStatus.rejectionReason).to.be.a(OrdersV0.RejectionReason);
                ...
                // expect(data.payload.regulatedOrderVerificationStatus.externalReviewerId).to.be("");
                {
                  ...
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                    expect(data).to.be.a(OrdersV0.ValidVerificationDetail);
                    ...
                    // expect(data.verificationDetailType).to.be("");
                    {
                      ...
                      for (let p in dataCtr) {
                        let data = dataCtr[p];
                        expect(data).to.be.a(OrdersV0.VerificationStatus);
                      }
                    }
                  }
                }
      ...
      describe('getOrders', function() {
        it('should call getOrders successfully', function(done) {
          ...
          instance.getOrders(marketplaceIds, opts).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(OrdersV0.GetOrdersResponse);
            expect(data.payload).to.be.a(OrdersV0.OrdersList);
                  expect(data.payload.orders).to.be.a(OrdersV0.OrderList);
                  expect(data.payload.nextToken).to.be.a('string');
              // expect(data.payload.nextToken).to.be("");
      ...
      describe('updateShipmentStatus', function() {
        it('should call updateShipmentStatus successfully', function(done) {
          ...
          /*
          var orderId = "orderId_example";
          var payload = new OrdersV0.UpdateShipmentStatusRequest();
          payload.marketplaceId = new OrdersV0.MarketplaceId();
          payload.shipmentStatus = new OrdersV0.ShipmentStatus();
          payload.orderItems = new OrdersV0.OrderItems();
      ...
      describe('updateVerificationStatus', function() {
        it('should call updateVerificationStatus successfully', function(done) {
          ...
          /*
          var orderId = "orderId_example";
          var payload = new OrdersV0.UpdateVerificationStatusRequest();
          payload.regulatedOrderVerificationStatus = new OrdersV0.UpdateVerificationStatusRequestBody();
          payload.regulatedOrderVerificationStatus.status = new OrdersV0.VerificationStatus();
          payload.regulatedOrderVerificationStatus.externalReviewerId = "";
          payload.regulatedOrderVerificationStatus.rejectionReasonId = "";
          payload.regulatedOrderVerificationStatus.verificationDetails = new OrdersV0.VerificationDetails();
          payload.regulatedOrderVerificationStatus.verificationDetails.prescriptionDetail = new OrdersV0.PrescriptionDetail();
