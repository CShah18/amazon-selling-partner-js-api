...
(function(root, factory) {
  ...
  describe('ordersV0', function() {
    describe('OpenInterval', function() {
      beforeEach(function() {
        instance = new OrdersV0.OpenInterval();
      });

      it('should create an instance of OpenInterval', function() {
        // TODO: update the code to test OpenInterval
        expect(instance).to.be.a(OrdersV0.OpenInterval);
      });
