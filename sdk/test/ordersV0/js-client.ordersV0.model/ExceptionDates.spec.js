...
(function(root, factory) {
  ...
  describe('ordersV0', function() {
    describe('ExceptionDates', function() {
      beforeEach(function() {
        instance = new OrdersV0.ExceptionDates();
      });

      it('should create an instance of ExceptionDates', function() {
        // TODO: update the code to test ExceptionDates
        expect(instance).to.be.a(OrdersV0.ExceptionDates);
      });

      it('should have the property exceptionDate (base name: "ExceptionDate")', function() {
        // TODO: update the code to test the property exceptionDate
        expect(instance).to.have.property('exceptionDate');
        // expect(instance.exceptionDate).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property openIntervals (base name: "OpenIntervals")', function() {
        // TODO: update the code to test the property openIntervals
        expect(instance).to.have.property('openIntervals');
        // expect(instance.openIntervals).to.be(expectedValueLiteral);
      });
