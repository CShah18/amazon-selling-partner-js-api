...
(function(root, factory) {
  ...
  describe('ordersV0', function() {
    describe('TaxCollection', function() {
      beforeEach(function() {
        instance = new OrdersV0.TaxCollection();
      });

      it('should create an instance of TaxCollection', function() {
        // TODO: update the code to test TaxCollection
        expect(instance).to.be.a(OrdersV0.TaxCollection);
      });
      ...
      it('should have the property responsibleParty (base name: "ResponsibleParty")', function() {
        // TODO: update the code to test the property responsibleParty
        expect(instance).to.have.property('responsibleParty');
        // expect(instance.responsibleParty).to.be(expectedValueLiteral);
      });
