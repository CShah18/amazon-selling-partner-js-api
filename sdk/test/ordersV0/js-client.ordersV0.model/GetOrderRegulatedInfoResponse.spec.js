...
(function(root, factory) {
  ...
  describe('ordersV0', function() {
    describe('GetOrderRegulatedInfoResponse', function() {
      beforeEach(function() {
        instance = new OrdersV0.GetOrderRegulatedInfoResponse();
      });

      it('should create an instance of GetOrderRegulatedInfoResponse', function() {
        // TODO: update the code to test GetOrderRegulatedInfoResponse
        expect(instance).to.be.a(OrdersV0.GetOrderRegulatedInfoResponse);
      });
