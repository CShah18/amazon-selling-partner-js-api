...
(function(root, factory) {
  ...
  describe('ordersV0', function() {
    describe('UpdateShipmentStatusErrorResponse', function() {
      beforeEach(function() {
        instance = new OrdersV0.UpdateShipmentStatusErrorResponse();
      });

      it('should create an instance of UpdateShipmentStatusErrorResponse', function() {
        // TODO: update the code to test UpdateShipmentStatusErrorResponse
        expect(instance).to.be.a(OrdersV0.UpdateShipmentStatusErrorResponse);
      });
