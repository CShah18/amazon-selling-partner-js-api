...
(function(root, factory) {
  ...
  describe('ordersV0', function() {
    describe('UpdateShipmentStatusRequest', function() {
      beforeEach(function() {
        instance = new OrdersV0.UpdateShipmentStatusRequest();
      });

      it('should create an instance of UpdateShipmentStatusRequest', function() {
        // TODO: update the code to test UpdateShipmentStatusRequest
        expect(instance).to.be.a(OrdersV0.UpdateShipmentStatusRequest);
      });
