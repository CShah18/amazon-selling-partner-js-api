...
(function(root, factory) {
  ...
  describe('ordersV0', function() {
    describe('GetOrderBuyerInfoResponse', function() {
      beforeEach(function() {
        instance = new OrdersV0.GetOrderBuyerInfoResponse();
      });

      it('should create an instance of GetOrderBuyerInfoResponse', function() {
        // TODO: update the code to test GetOrderBuyerInfoResponse
        expect(instance).to.be.a(OrdersV0.GetOrderBuyerInfoResponse);
      });
