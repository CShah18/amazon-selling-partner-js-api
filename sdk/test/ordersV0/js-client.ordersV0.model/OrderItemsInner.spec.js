...
(function(root, factory) {
  ...
  describe('ordersV0', function() {
    describe('OrderItemsInner', function() {
      beforeEach(function() {
        instance = new OrdersV0.OrderItemsInner();
      });

      it('should create an instance of OrderItemsInner', function() {
        // TODO: update the code to test OrderItemsInner
        expect(instance).to.be.a(OrdersV0.OrderItemsInner);
      });
