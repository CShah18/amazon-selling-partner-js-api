...
(function(root, factory) {
  ...
  describe('ordersV0', function() {
    describe('OrderItemsBuyerInfoList', function() {
      beforeEach(function() {
        instance = new OrdersV0.OrderItemsBuyerInfoList();
      });

      it('should create an instance of OrderItemsBuyerInfoList', function() {
        // TODO: update the code to test OrderItemsBuyerInfoList
        expect(instance).to.be.a(OrdersV0.OrderItemsBuyerInfoList);
      });
