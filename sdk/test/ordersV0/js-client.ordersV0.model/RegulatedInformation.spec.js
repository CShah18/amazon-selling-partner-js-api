...
(function(root, factory) {
  ...
  describe('ordersV0', function() {
    describe('RegulatedInformation', function() {
      beforeEach(function() {
        instance = new OrdersV0.RegulatedInformation();
      });

      it('should create an instance of RegulatedInformation', function() {
        // TODO: update the code to test RegulatedInformation
        expect(instance).to.be.a(OrdersV0.RegulatedInformation);
      });
