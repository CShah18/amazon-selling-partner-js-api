...
(function(root, factory) {
  ...
  describe('ordersV0', function() {
    describe('SubstitutionPreferences', function() {
      beforeEach(function() {
        instance = new OrdersV0.SubstitutionPreferences();
      });

      it('should create an instance of SubstitutionPreferences', function() {
        // TODO: update the code to test SubstitutionPreferences
        expect(instance).to.be.a(OrdersV0.SubstitutionPreferences);
      });

      it('should have the property substitutionType (base name: "SubstitutionType")', function() {
        // TODO: update the code to test the property substitutionType
        expect(instance).to.have.property('substitutionType');
        // expect(instance.substitutionType).to.be(expectedValueLiteral);
      });

      it('should have the property substitutionOptions (base name: "SubstitutionOptions")', function() {
        // TODO: update the code to test the property substitutionOptions
        expect(instance).to.have.property('substitutionOptions');
        // expect(instance.substitutionOptions).to.be(expectedValueLiteral);
      });
