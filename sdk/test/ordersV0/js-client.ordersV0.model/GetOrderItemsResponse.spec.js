...
(function(root, factory) {
  ...
  describe('ordersV0', function() {
    describe('GetOrderItemsResponse', function() {
      beforeEach(function() {
        instance = new OrdersV0.GetOrderItemsResponse();
      });

      it('should create an instance of GetOrderItemsResponse', function() {
        // TODO: update the code to test GetOrderItemsResponse
        expect(instance).to.be.a(OrdersV0.GetOrderItemsResponse);
      });
