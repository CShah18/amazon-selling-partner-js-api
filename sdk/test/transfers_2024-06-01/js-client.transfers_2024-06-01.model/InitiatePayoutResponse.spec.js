  ...
  describe('transfers_2024-06-01', function() {
    describe('InitiatePayoutResponse', function() {
      ...
      it('should create an instance of InitiatePayoutResponse', function() {
        // TODO: update the code to test InitiatePayoutResponse
      ...
      it('should have the property payoutReferenceId (base name: "payoutReferenceId")', function() {
        // TODO: update the code to test the property payoutReferenceId
        expect(instance).to.have.property('payoutReferenceId');
        // expect(instance.payoutReferenceId).to.be(expectedValueLiteral);
      });
