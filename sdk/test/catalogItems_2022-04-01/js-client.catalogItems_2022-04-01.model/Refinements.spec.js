...
(function(root, factory) {
  ...
  describe('catalogItems_2022-04-01', function() {
    describe('Refinements', function() {
      beforeEach(function() {
        instance = new CatalogItemsV20220401.Refinements();
      });

      it('should create an instance of Refinements', function() {
        // TODO: update the code to test Refinements
        expect(instance).to.be.a(CatalogItemsV20220401.Refinements);
      });

      it('should have the property brands (base name: "brands")', function() {
        // TODO: update the code to test the property brands
        expect(instance).to.have.property('brands');
        // expect(instance.brands).to.be(expectedValueLiteral);
      });
