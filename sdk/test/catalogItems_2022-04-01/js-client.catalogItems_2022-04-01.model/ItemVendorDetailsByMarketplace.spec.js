...
(function(root, factory) {
  ...
  describe('catalogItems_2022-04-01', function() {
    describe('ItemVendorDetailsByMarketplace', function() {
      beforeEach(function() {
        instance = new CatalogItemsV20220401.ItemVendorDetailsByMarketplace();
      });
      ...
      it('should create an instance of ItemVendorDetailsByMarketplace', function() {
        ...
        expect(instance).to.be.a(CatalogItemsV20220401.ItemVendorDetailsByMarketplace);
      });
      ...
      it('should have the property productSubcategory (base name: "productSubcategory")', function() {
        // TODO: update the code to test the property productSubcategory
        expect(instance).to.have.property('productSubcategory');
        // expect(instance.productSubcategory).to.be(expectedValueLiteral);
      });
