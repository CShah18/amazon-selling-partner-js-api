...
(function(root, factory) {
  ...
  describe('catalogItems_2022-04-01', function() {
    describe('ItemSummaries', function() {
      beforeEach(function() {
        instance = new CatalogItemsV20220401.ItemSummaries();
      });

      it('should create an instance of ItemSummaries', function() {
        // TODO: update the code to test ItemSummaries
        expect(instance).to.be.a(CatalogItemsV20220401.ItemSummaries);
      });
