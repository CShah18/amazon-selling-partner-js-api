...
(function(root, factory) {
  ...
  describe('catalogItems_2022-04-01', function() {
    describe('ItemIdentifier', function() {
      beforeEach(function() {
        instance = new CatalogItemsV20220401.ItemIdentifier();
      });

      it('should create an instance of ItemIdentifier', function() {
        // TODO: update the code to test ItemIdentifier
        expect(instance).to.be.a(CatalogItemsV20220401.ItemIdentifier);
      });

      it('should have the property identifierType (base name: "identifierType")', function() {
        // TODO: update the code to test the property identifierType
        expect(instance).to.have.property('identifierType');
        // expect(instance.identifierType).to.be(expectedValueLiteral);
      });
