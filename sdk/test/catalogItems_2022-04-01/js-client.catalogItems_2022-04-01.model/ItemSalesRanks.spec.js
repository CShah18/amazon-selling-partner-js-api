...
(function(root, factory) {
  ...
  describe('catalogItems_2022-04-01', function() {
    describe('ItemSalesRanks', function() {
      beforeEach(function() {
        instance = new CatalogItemsV20220401.ItemSalesRanks();
      });

      it('should create an instance of ItemSalesRanks', function() {
        // TODO: update the code to test ItemSalesRanks
        expect(instance).to.be.a(CatalogItemsV20220401.ItemSalesRanks);
      });
