...
(function(root, factory) {
  ...
  describe('catalogItems_2022-04-01', function() {
    describe('ItemImagesByMarketplace', function() {
      beforeEach(function() {
        instance = new CatalogItemsV20220401.ItemImagesByMarketplace();
      });

      it('should create an instance of ItemImagesByMarketplace', function() {
        // TODO: update the code to test ItemImagesByMarketplace
        expect(instance).to.be.a(CatalogItemsV20220401.ItemImagesByMarketplace);
      });
