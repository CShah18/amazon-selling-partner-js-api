...
(function(root, factory) {
  ...
  describe('catalogItems_2022-04-01', function() {
    describe('ItemAttributes', function() {
      beforeEach(function() {
        instance = new CatalogItemsV20220401.ItemAttributes();
      });

      it('should create an instance of ItemAttributes', function() {
        // TODO: update the code to test ItemAttributes
        expect(instance).to.be.a(CatalogItemsV20220401.ItemAttributes);
      });
