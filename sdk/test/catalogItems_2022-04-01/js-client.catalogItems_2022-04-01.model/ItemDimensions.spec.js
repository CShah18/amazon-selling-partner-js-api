...
(function(root, factory) {
  ...
  describe('catalogItems_2022-04-01', function() {
    describe('ItemDimensions', function() {
      beforeEach(function() {
        instance = new CatalogItemsV20220401.ItemDimensions();
      });

      it('should create an instance of ItemDimensions', function() {
        // TODO: update the code to test ItemDimensions
        expect(instance).to.be.a(CatalogItemsV20220401.ItemDimensions);
      });
