...
(function(root, factory) {
  ...
  describe('catalogItems_2022-04-01', function() {
    describe('ItemDisplayGroupSalesRank', function() {
      beforeEach(function() {
        instance = new CatalogItemsV20220401.ItemDisplayGroupSalesRank();
      });

      it('should create an instance of ItemDisplayGroupSalesRank', function() {
        // TODO: update the code to test ItemDisplayGroupSalesRank
        expect(instance).to.be.a(CatalogItemsV20220401.ItemDisplayGroupSalesRank);
      });
