...
(function(root, factory) {
  ...
  describe('catalogItems_2022-04-01', function() {
    describe('ItemImages', function() {
      beforeEach(function() {
        instance = new CatalogItemsV20220401.ItemImages();
      });

      it('should create an instance of ItemImages', function() {
        // TODO: update the code to test ItemImages
        expect(instance).to.be.a(CatalogItemsV20220401.ItemImages);
      });
