...
(function(root, factory) {
  ...
  describe('catalogItems_2022-04-01', function() {
    describe('ItemBrowseClassification', function() {
      beforeEach(function() {
        instance = new CatalogItemsV20220401.ItemBrowseClassification();
      });

      it('should create an instance of ItemBrowseClassification', function() {
        // TODO: update the code to test ItemBrowseClassification
        expect(instance).to.be.a(CatalogItemsV20220401.ItemBrowseClassification);
      });
