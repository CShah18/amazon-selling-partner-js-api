...
(function(root, factory) {
  ...
  describe('catalogItems_2022-04-01', function() {
    describe('ItemSalesRanksByMarketplace', function() {
      beforeEach(function() {
        instance = new CatalogItemsV20220401.ItemSalesRanksByMarketplace();
      });

      it('should create an instance of ItemSalesRanksByMarketplace', function() {
        // TODO: update the code to test ItemSalesRanksByMarketplace
        expect(instance).to.be.a(CatalogItemsV20220401.ItemSalesRanksByMarketplace);
      });
      ...
      it('should have the property classificationRanks (base name: "classificationRanks")', function() {
        // TODO: update the code to test the property classificationRanks
        expect(instance).to.have.property('classificationRanks');
        // expect(instance.classificationRanks).to.be(expectedValueLiteral);
      });

      it('should have the property displayGroupRanks (base name: "displayGroupRanks")', function() {
        // TODO: update the code to test the property displayGroupRanks
        expect(instance).to.have.property('displayGroupRanks');
        // expect(instance.displayGroupRanks).to.be(expectedValueLiteral);
      });
