...
(function(root, factory) {
  ...
  describe('feeds_2021-06-30', function() {
    describe('CreateFeedDocumentSpecification', function() {
      beforeEach(function() {
        instance = new FeedsV20210630.CreateFeedDocumentSpecification();
      });

      it('should create an instance of CreateFeedDocumentSpecification', function() {
        // TODO: update the code to test CreateFeedDocumentSpecification
        expect(instance).to.be.a(FeedsV20210630.CreateFeedDocumentSpecification);
      });
