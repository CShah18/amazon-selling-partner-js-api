...
(function(root, factory) {
  ...
  describe('feeds_2021-06-30', function() {
    describe('FeedOptions', function() {
      beforeEach(function() {
        instance = new FeedsV20210630.FeedOptions();
      });

      it('should create an instance of FeedOptions', function() {
        // TODO: update the code to test FeedOptions
        expect(instance).to.be.a(FeedsV20210630.FeedOptions);
      });
