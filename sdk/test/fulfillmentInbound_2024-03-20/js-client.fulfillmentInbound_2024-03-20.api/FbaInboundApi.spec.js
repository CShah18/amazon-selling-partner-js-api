              ...
              for (let p in dataCtr) {
                ...
                expect(data.dimensions).to.be.a(TheSellingPartnerApiForFbaInboundOperations.Dimensions);
                  ...
                  expect(data.dimensions.unitOfMeasurement).to.be.a(TheSellingPartnerApiForFbaInboundOperations.UnitOfMeasurement);
                      expect(data.dimensions.width).to.be.a('number');
                  // expect(data.dimensions.width).to.be();
                expect(data.externalContainerIdentifier).to.be.a('string');
                // expect(data.externalContainerIdentifier).to.be("");
                expect(data.externalContainerIdentifierType).to.be.a('string');
                // expect(data.externalContainerIdentifierType).to.be("");
                {
                  let dataCtr = data.items;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
          ...
          instance.listPackingOptions(inboundPlanId, opts).then(function(data) {
            ...
            expect(data).to.be.a(TheSellingPartnerApiForFbaInboundOperations.ListPackingOptionsResponse);
            {
              ...
              for (let p in dataCtr) {
                ...
                // expect(data.status).to.be("");
                {
                  let dataCtr = data.supportedConfigurations;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                    expect(data).to.be.a(TheSellingPartnerApiForFbaInboundOperations.PackingConfiguration);
                    {
                      let dataCtr = data.boxPackingMethods;
                      expect(dataCtr).to.be.an(Array);
                      expect(dataCtr).to.not.be.empty();
                      for (let p in dataCtr) {
                        let data = dataCtr[p];
                        expect(data).to.be.a(TheSellingPartnerApiForFbaInboundOperations.BoxContentInformationSource);
                      }
                    }
                    expect(data.boxRequirements).to.be.a(TheSellingPartnerApiForFbaInboundOperations.BoxRequirements);
                          expect(data.boxRequirements.weight).to.be.a(TheSellingPartnerApiForFbaInboundOperations.WeightRange);
                            expect(data.boxRequirements.weight.maximum).to.be.a('number');
                        // expect(data.boxRequirements.weight.maximum).to.be();
                        expect(data.boxRequirements.weight.minimum).to.be.a('number');
                        // expect(data.boxRequirements.weight.minimum).to.be();
                        expect(data.boxRequirements.weight.unit).to.be.a(TheSellingPartnerApiForFbaInboundOperations.UnitOfWeight);
                
                    {
                      let dataCtr = data.shippingRequirements;
                      expect(dataCtr).to.be.an(Array);
                      expect(dataCtr).to.not.be.empty();
                      for (let p in dataCtr) {
                        let data = dataCtr[p];
                        expect(data).to.be.a(TheSellingPartnerApiForFbaInboundOperations.ShippingRequirements);
                        {
                          let dataCtr = data.modes;
                          expect(dataCtr).to.be.an(Array);
                          expect(dataCtr).to.not.be.empty();
                          for (let p in dataCtr) {
                            let data = dataCtr[p];
