...
(function(root, factory) {
  ...
  describe('fulfillmentInbound_2024-03-20', function() {
    describe('ShippingRequirements', function() {
      beforeEach(function() {
        instance = new TheSellingPartnerApiForFbaInboundOperations.ShippingRequirements();
      });

      it('should create an instance of ShippingRequirements', function() {
        // TODO: update the code to test ShippingRequirements
      ...
      it('should have the property modes (base name: "modes")', function() {
        // TODO: update the code to test the property modes
        expect(instance).to.have.property('modes');
        // expect(instance.modes).to.be(expectedValueLiteral);
      });
