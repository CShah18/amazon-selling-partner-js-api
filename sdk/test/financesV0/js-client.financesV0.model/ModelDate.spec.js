...
(function(root, factory) {
  ...
  describe('financesV0', function() {
    describe('ModelDate', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForFinances.ModelDate();
      });

      it('should create an instance of ModelDate', function() {
        // TODO: update the code to test ModelDate
        expect(instance).to.be.a(SellingPartnerApiForFinances.ModelDate);
      });
