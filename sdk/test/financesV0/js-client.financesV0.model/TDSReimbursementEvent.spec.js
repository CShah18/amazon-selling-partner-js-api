...
(function(root, factory) {
  ...
  describe('financesV0', function() {
    describe('TDSReimbursementEvent', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForFinances.TDSReimbursementEvent();
      });

      it('should create an instance of TDSReimbursementEvent', function() {
        // TODO: update the code to test TDSReimbursementEvent
      ...
      it('should have the property tDSOrderId (base name: "TDSOrderId")', function() {
        // TODO: update the code to test the property tDSOrderId
        expect(instance).to.have.property('tDSOrderId');
        // expect(instance.tDSOrderId).to.be(expectedValueLiteral);
      });
