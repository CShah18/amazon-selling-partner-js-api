...
(function(root, factory) {
  ...
  describe('financesV0', function() {
    describe('AdhocDisbursementEvent', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForFinances.AdhocDisbursementEvent();
      });

      it('should create an instance of AdhocDisbursementEvent', function() {
        // TODO: update the code to test AdhocDisbursementEvent
