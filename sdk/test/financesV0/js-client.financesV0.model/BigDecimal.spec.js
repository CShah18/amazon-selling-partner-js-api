...
(function(root, factory) {
  ...
  describe('financesV0', function() {
    describe('BigDecimal', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForFinances.BigDecimal();
      });

      it('should create an instance of BigDecimal', function() {
        // TODO: update the code to test BigDecimal
        expect(instance).to.be.a(SellingPartnerApiForFinances.BigDecimal);
      });
