...
(function(root, factory) {
  ...
  describe('financesV0', function() {
    describe('TaxWithheldComponent', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForFinances.TaxWithheldComponent();
      });

      it('should create an instance of TaxWithheldComponent', function() {
        // TODO: update the code to test TaxWithheldComponent
      ...
      it('should have the property taxesWithheld (base name: "TaxesWithheld")', function() {
        // TODO: update the code to test the property taxesWithheld
        expect(instance).to.have.property('taxesWithheld');
        // expect(instance.taxesWithheld).to.be(expectedValueLiteral);
      });
