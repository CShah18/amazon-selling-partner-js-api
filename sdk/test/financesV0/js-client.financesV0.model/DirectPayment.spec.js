  ...
  describe('financesV0', function() {
    describe('DirectPayment', function() {
      ...
      it('should create an instance of DirectPayment', function() {
        // TODO: update the code to test DirectPayment
      ...
      it('should have the property directPaymentType (base name: "DirectPaymentType")', function() {
        // TODO: update the code to test the property directPaymentType
        expect(instance).to.have.property('directPaymentType');
        // expect(instance.directPaymentType).to.be(expectedValueLiteral);
      });

      it('should have the property directPaymentAmount (base name: "DirectPaymentAmount")', function() {
        // TODO: update the code to test the property directPaymentAmount
        expect(instance).to.have.property('directPaymentAmount');
        // expect(instance.directPaymentAmount).to.be(expectedValueLiteral);
      });
