...
(function(root, factory) {
  ...
  describe('listingsItems_2021-08-01', function() {
    describe('ItemProductTypes', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForListingsItems.ItemProductTypes();
      });

      it('should create an instance of ItemProductTypes', function() {
        // TODO: update the code to test ItemProductTypes
        expect(instance).to.be.a(SellingPartnerApiForListingsItems.ItemProductTypes);
      });
