...
(function(root, factory) {
  ...
  describe('listingsItems_2021-08-01', function() {
    describe('ItemProductTypeByMarketplace', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForListingsItems.ItemProductTypeByMarketplace();
      });

      it('should create an instance of ItemProductTypeByMarketplace', function() {
        // TODO: update the code to test ItemProductTypeByMarketplace
        expect(instance).to.be.a(SellingPartnerApiForListingsItems.ItemProductTypeByMarketplace);
      });
