    ...
    describe('ListingsApi', function() {
      ...
      describe('getListingsItem', function() {
        it('should call getListingsItem successfully', function(done) {
          ...
          instance.getListingsItem(sellerId, sku, marketplaceIds, opts).then(function(data) {
            ...
            expect(data.relationships).to.be.a(SellingPartnerApiForListingsItems.ItemRelationships);
                expect(data.productTypes).to.be.a(SellingPartnerApiForListingsItems.ItemProductTypes);
      ...
      describe('searchListingsItems', function() {
        it('should call searchListingsItems successfully', function(done) {
          ...
          opts.variationParentSku = "GM-ZDPI-9B4E";
          opts.packageHierarchySku = "GM-ZDPI-9B4E";
          opts.createdAfter = new Date("2024-03-01T01:30:00.000Z");
          opts.createdBefore = new Date("2024-03-31T21:45:00.000Z");
          opts.lastUpdatedAfter = new Date("2024-05-05T23:45:00.000Z");
          opts.lastUpdatedBefore = new Date("2024-05-01T01:15:00.000Z");
          opts.withIssueSeverity = ["WARNING"];
          opts.withStatus = ["DISCOVERABLE"];
          opts.withoutStatus = ["BUYABLE"];
          opts.sortBy = "lastUpdatedDate";
          opts.sortOrder = "DESC";
          opts.pageSize = 10;
