...
(function(root, factory) {
  ...
  describe('productPricing_2022-05-01', function() {
    describe('SegmentDetails', function() {
      ...
      it('should create an instance of SegmentDetails', function() {
        // TODO: update the code to test SegmentDetails
      ...
      it('should have the property glanceViewWeightPercentage (base name: "glanceViewWeightPercentage")', function() {
        // TODO: update the code to test the property glanceViewWeightPercentage
        expect(instance).to.have.property('glanceViewWeightPercentage');
        // expect(instance.glanceViewWeightPercentage).to.be(expectedValueLiteral);
      });

      it('should have the property sampleLocation (base name: "sampleLocation")', function() {
        // TODO: update the code to test the property sampleLocation
        expect(instance).to.have.property('sampleLocation');
        // expect(instance.sampleLocation).to.be(expectedValueLiteral);
      });
